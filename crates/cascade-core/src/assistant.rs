...
pub fn builtin_scenarios() -> Vec<Scenario> {
    ...
    vec![
        Scenario {
            id: "backup_photos",
            title: crate::n("Back up photos"),
            description: crate::n(
                "Copy a photo folder to another disk or location. Never deletes.",
            ),
            note: crate::n(""),
            tool: Rsync,
            op: Copy,
        ...
        Scenario {
            id: "backup_projects",
            title: crate::n("Back up programming projects"),
            description: crate::n("Copy your code projects to a backup location. Never deletes."),
            note: crate::n("Tip: in Advanced mode you can exclude node_modules, target/, etc."),
            tool: Rsync,
            op: Copy,
            delete: false,
            recommend_dry_run: false,
        ...
        Scenario {
            id: "backup_personal",
            title: crate::n("Back up a personal folder"),
            description: crate::n("Copy a folder such as Documents to a backup location."),
            note: crate::n(""),
            tool: Rsync,
            op: Copy,
            delete: false,
        ...
        Scenario {
            id: "backup_to_gdrive",
            title: crate::n("Back up to Google Drive"),
            description: crate::n("Copy a local folder to a Google Drive remote. Never deletes."),
            note: crate::n("Requires a configured rclone remote (e.g. gdrive:)."),
            tool: Rclone,
            op: Copy,
            delete: false,
            recommend_dry_run: false,
        ...
        Scenario {
            ...
            title: crate::n("Back up to a VPS over SSH"),
            description: crate::n("Copy a local folder to a server via rsync over SSH."),
            note: crate::n("Set the destination as user@host:/path. SSH keys must be set up."),
            tool: Rsync,
            op: Copy,
            delete: false,
            recommend_dry_run: false,
        ...
        Scenario {
            id: "sync_two_local",
            title: crate::n("Sync two local folders (mirror)"),
            description: crate::n("Make the destination identical to the source."),
            note: crate::n(
                "DESTRUCTIVE: files only in the destination will be deleted. Dry-run first!",
            ),
            tool: Rsync,
            op: Sync,
            delete: true,
        ...
        Scenario {
            ...
            title: crate::n("Mirror a folder to a remote"),
            description: crate::n("Make a cloud remote an exact mirror of a local folder."),
            note: crate::n(
                "DESTRUCTIVE: extra files on the remote will be deleted. Dry-run first!",
            ),
            tool: Rclone,
            op: Sync,
            delete: true,
        ...
        Scenario {
            ...
            title: crate::n("Restore from a backup"),
            description: crate::n(
                "Copy files back from a backup location to their original folder.",
            ),
            note: crate::n("Always dry-run first to confirm what will be written."),
            tool: Rsync,
            op: Copy,
            delete: false,
            recommend_dry_run: true,
